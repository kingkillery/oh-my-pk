...
- default agent dir: `~/.ompk/agent`
- effective default file: `~/.ompk/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.ompk/agent/themes/my-theme.json`.
