...
2. Managed venv at `~/.ompk/python-env`
...
- **No Python on PATH** — Install a system Python 3.8+ or place a venv at `~/.ompk/python-env`. `oh-my-pk setup python --check` reports the resolved interpreter.
