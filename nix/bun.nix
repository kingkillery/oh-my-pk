...
}:
{
  ...
  "@pk-nerdsaver-ai/browser-relay" = copyPathToStore ../packages/browser-relay;
  "@pk-nerdsaver-ai/collab-web" = copyPathToStore ../packages/collab-web;
  "@pk-nerdsaver-ai/hashline" = copyPathToStore ../packages/hashline;
  "@pk-nerdsaver-ai/omp-stats" = copyPathToStore ../packages/stats;
  "@pk-nerdsaver-ai/omptype" = copyPathToStore ../packages/omptype;
  "@pk-nerdsaver-ai/pi-agent-core" = copyPathToStore ../packages/agent;
  "@pk-nerdsaver-ai/pi-ai" = copyPathToStore ../packages/ai;
  "@pk-nerdsaver-ai/pi-catalog" = copyPathToStore ../packages/catalog;
  "@pk-nerdsaver-ai/pi-coding-agent" = copyPathToStore ../packages/coding-agent;
  "@pk-nerdsaver-ai/pi-metaharness" = copyPathToStore ../packages/metaharness;
  "@pk-nerdsaver-ai/pi-mnemopi" = copyPathToStore ../packages/mnemopi;
  "@pk-nerdsaver-ai/pi-natives" = copyPathToStore ../packages/natives;
  "@pk-nerdsaver-ai/pi-tui" = copyPathToStore ../packages/tui;
  "@pk-nerdsaver-ai/pi-utils" = copyPathToStore ../packages/utils;
  "@pk-nerdsaver-ai/pi-wire" = copyPathToStore ../packages/wire;
  "@pk-nerdsaver-ai/snapcompact" = copyPathToStore ../packages/snapcompact;
  "@pk-nerdsaver-ai/typescript-edit-benchmark" = copyPathToStore ../packages/typescript-edit-benchmark;
