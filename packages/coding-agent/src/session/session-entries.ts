...
import type { ImageContent, MessageAttribution, ServiceTierByFamily, TextContent } from "@pk-nerdsaver-ai/pi-ai";
...
declare module "@pk-nerdsaver-ai/pi-agent-core/compaction/entries" {
