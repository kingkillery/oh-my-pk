...
import { compileRuleCondition } from "@pk-nerdsaver-ai/pi-coding-agent/capability/rule";
import { buildRuleFromMarkdown, createSourceMeta } from "@pk-nerdsaver-ai/pi-coding-agent/discovery/helpers";
