...
import type { EffectiveExtensionRoots } from "@pk-nerdsaver-ai/pi-coding-agent/capability/types";
import { ModelRegistry } from "@pk-nerdsaver-ai/pi-coding-agent/config/model-registry";
import { Settings } from "@pk-nerdsaver-ai/pi-coding-agent/config/settings";
import "@pk-nerdsaver-ai/pi-coding-agent/discovery";
import { setActiveSkills } from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/skills";
