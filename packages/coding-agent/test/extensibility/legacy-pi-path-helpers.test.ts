...
import * as configModule from "@pk-nerdsaver-ai/pi-coding-agent/config";
import * as shim from "@pk-nerdsaver-ai/pi-coding-agent/extensibility/legacy-pi-coding-agent-shim";
import * as utils from "@pk-nerdsaver-ai/pi-utils";
