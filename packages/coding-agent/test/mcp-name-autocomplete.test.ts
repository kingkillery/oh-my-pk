...
import { collectMcpServerNames } from "@pk-nerdsaver-ai/pi-coding-agent/modes/controllers/mcp-command-controller";
import type { InteractiveModeContext } from "@pk-nerdsaver-ai/pi-coding-agent/modes/types";
import { buildTuiBuiltinSlashCommands } from "@pk-nerdsaver-ai/pi-coding-agent/slash-commands/builtin-registry";
import type { TuiSlashCommandRuntime } from "@pk-nerdsaver-ai/pi-coding-agent/slash-commands/types";
import {
	getConfigRootDir,
	getMCPConfigPath,
	getProjectDir,
