...
import { COMPOSER_SHAPE_VALUES, type ComposerShape } from "@pk-nerdsaver-ai/pi-coding-agent/config/settings-schema";
import {
	ComposerShapePreview,
	renderComposerShapePreview,
} from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/composer-shape-preview";
import {
	getComposerShapeOptions,
	installExtensionComposerShape,
} from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/composer-shape-registry";
import { SettingsSelectorComponent } from "@pk-nerdsaver-ai/pi-coding-agent/modes/components/settings-selector";
import { initTheme, setTheme } from "@pk-nerdsaver-ai/pi-coding-agent/modes/theme/theme";
