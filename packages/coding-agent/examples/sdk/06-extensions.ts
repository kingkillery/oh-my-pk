 ...
 * - ~/.ompk/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.ompk/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.ompk/agent/extensions/ or .ompk/extensions/
